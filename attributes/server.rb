...
override['logstash']['instance']['server']['pattern_templates']  = { 'default' => 'patterns/custom_patterns.erb' }
override['logstash']['instance']['server']['elasticsearch_ip']  = '127.0.0.1'
override['logstash']['instance']['server']['enable_embedded_es'] = true
