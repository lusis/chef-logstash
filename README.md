# <a name="title"></a> chef-logstash [![Build Status](https://secure.travis-ci.org/DrillingInfo/chef-logstash.png?branch=master)](http://travis-ci.org/DrillingInfo/chef-logstash)
